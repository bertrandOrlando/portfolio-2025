  ...
  return (
    <section className="flex w-full flex-col gap-y-4 py-20">
      ...
      <div className="grid grid-cols-6 gap-4">
        <p className="col-span-5 text-xl font-semibold text-slate-900 md:text-2xl">
        ...
        <p className="col-span-5 col-start-2 text-xl font-semibold text-slate-900 md:text-2xl">
